...
const CVAnalysis = () => {
  ...
  return (
    <PageTransition>
      <GradientBackground className="min-h-screen pt-24 pb-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl font-bold mb-2 bg-gradient-to-r from-primary to-blue-600 text-transparent bg-clip-text">CV Analysis & Recommendations</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <Card className="p-6 rounded-xl h-full shadow-lg border border-primary/10 hover:border-primary/30 transition-all hover:shadow-xl">
                ...
                <Button 
                  ...
                  className="w-full py-6 rounded-xl bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-700 transition-all"
                >
                  {isAnalyzing ? (
                    <>
            ...
            >
              {analysis ? (
                <Card className="p-6 rounded-xl h-full shadow-lg border border-primary/10 hover:border-primary/30 transition-all hover:shadow-xl overflow-y-auto">
                  <div className="flex items-center mb-4">
                ...
                <Card className="p-6 rounded-xl h-full flex items-center justify-center shadow-lg border border-primary/10">
